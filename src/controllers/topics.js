...
topicsController.get = function getTopic(req, res, callback) {
	...
	var done = (tid !== undefined);


	//If tid is undefined search by topic title
	if (req.params.topic_id === undefined){

		console.log("Topic name = " + req.params.topicName);

		done=false;
		let search = topics.getTopicByTitle(req.params.topicName);
		search.then(function (result) {

			console.log("Result id = " + result.tid);

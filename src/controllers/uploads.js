...
uploadsController.uploadPost = function (req, res, next) {
	trainingFlag = req.headers.train === 'train';
	if (trainingFlag) {
		trainingSubFolder = req.headers.subfolder;
	}
...
function saveFileToLocal(uid, uploadedFile, callback) {
	...
	var folder = trainingFlag ? 'files/trainings/' + trainingSubFolder : 'files';

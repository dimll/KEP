			...
			<div class="btn-toolbar formatting-bar">
				<ul class="formatting-group">
					...
					<div id="customForm" class="hidden" >
						Training: <input type="text" id="trainingSubFolder" name="subfolder"/>&emsp;
						File #1: <input type="file" id="formFile1" name="file1[]" multiple class="gte-ie9" accept=".bin" style="display:inline-block"/>
						File #2: <input type="file" id="formFile2" name="file2[]" multiple class="gte-ie9" accept=".json" style="display:inline-block"/>
						<button type="button" id="uploadFormFiles">Upload Files</button>
						<br/><br/>
						Short description: <input type="text" id="shortDescText" size="130"/>
					</div>
				</ul>
			</div>
		</div>
